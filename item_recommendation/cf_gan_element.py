...
from gen_model_element import GEN
import cPickle
import numpy as np
import utils as ut
...
def simple_test_one_user(x):
    ...
    ndcg_2 = ndcg_at_k(r, 2)
    ndcg_3 = ndcg_at_k(r, 3)
    ndcg_4 = ndcg_at_k(r, 4)
    ndcg_5 = ndcg_at_k(r, 5)
    ndcg_6 = ndcg_at_k(r, 6)
    ndcg_7 = ndcg_at_k(r, 7)
    ndcg_8 = ndcg_at_k(r, 8)
    ndcg_9 = ndcg_at_k(r, 9)
    ndcg_10 = ndcg_at_k(r, 10)

    return np.array([p_1,p_2,p_3,p_4,p_5,p_6,p_7,p_8,p_9,p_10, ndcg_1,ndcg_2,ndcg_3,ndcg_4,ndcg_5,ndcg_6,ndcg_7,ndcg_8, ndcg_9, ndcg_10])


def simple_test(sess, model):
    result = np.array([0.] * 20)
